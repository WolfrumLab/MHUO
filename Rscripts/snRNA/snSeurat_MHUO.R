...
# Figures 1, 2 and associated extended data
...
snData <- CreateSeuratObject(counts = out, project = "visAT_MHO_M", min.cells = 3, min.features = 200)
...
saveRDS(snData_sub, "../visAT_MHO_M.rds")
